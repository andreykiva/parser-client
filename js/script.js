...
const getData = (event) => {
	...
	fetch("https://clumsy-ruby-hatchling.cyclic.app/api/parse", {
		method: "post",
		headers: {
		...
		.then((data) => {
			if (data.message == "Success") {
				$downloadBtn.href =
					"https://clumsy-ruby-hatchling.cyclic.app/data/" + data.filename;
...
const removeUser = (login) => {
	...
	fetch("https://clumsy-ruby-hatchling.cyclic.app/api/auth/remove", {
		method: "delete",
		headers: {
			Accept: "application/json",
			"Content-Type": "application/json",
...
const getUsers = () => {
	...
	fetch("https://clumsy-ruby-hatchling.cyclic.app/api/auth/users", {
		method: "get",
		headers: {
			Authorization: "Bearer " + token,
		},
...
$authBtn.addEventListener("click", (e) => {
	...
	fetch("https://clumsy-ruby-hatchling.cyclic.app/api/auth/login", {
		method: "post",
		headers: {
			Accept: "application/json",
			"Content-Type": "application/json",
...
$createBtn.addEventListener("click", (e) => {
	...
	fetch("https://clumsy-ruby-hatchling.cyclic.app/api/auth/registration", {
		method: "post",
		headers: {
			Accept: "application/json",
			"Content-Type": "application/json",
...
$openLogs.addEventListener("click", (e) => {
	...
	fetch("https://clumsy-ruby-hatchling.cyclic.app/api/auth/logs", {
		method: "get",
		headers: {
			Authorization: "Bearer " + token,
		},
		...
		.then((res) => res.json())
		.then((data) => {
			window.open(`https://clumsy-ruby-hatchling.cyclic.app/logs/${data.filename}`);
		});
});
...
const getRoles = (token) => {
	fetch("https://clumsy-ruby-hatchling.cyclic.app/api/auth/roles", {
		headers: {
			Authorization: "Bearer " + token,
		},
	})
